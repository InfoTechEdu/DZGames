    ...
    <AboutUsStyle>
      <Container>
        <GrayBlock
          ...
          isMainTitle={true}
          isImg={true}
          description={"Мы помогаем детям улучшить свои навыки функциональной грамотности. Используя инновационные методы обучения, мы стремимся помочь детям улучшить свои знания и создать будущих лидеров. Мы упаковываем обучение в интересный игровой формат разных жанров, чтобы каждый ребенок мог найти игру, которая ему нравится. Наша убеждение - обучение должно быть не только полезным, но и увлекательным, и все наши игры разработаны с учетом этого подхода. Мы постоянно работаем над улучшением наших продуктов и стремимся создавать игры, которые будут максимально полезны для детей. Спасибо вам за то, что выбрали наши игры для развития своих навыков функциональной грамотности! Наши двери всегда открыты к сотрудничеству с образовательными организациями и экспертами в области обучения, чтобы взаимодействовать и усовершенствовать нашу продукцию. Мы верим, что наша игровая платформа поможет школьникам достичь больших успехов в учебе и дает возможность весело проводить время, не забывая обучаться при этом."}
        />
