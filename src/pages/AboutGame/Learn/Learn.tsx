...
export const Learn = () => {
  return (
    <div className="relative">
      ...
      <LearnStyle>
        <LearnDescription>
        Игра про юнгу Мура поможет тебе развить функциональную грамотность и даже познакомиться с азами строительства. Ты также овладеешь умениями решать проблемы и планировать стратегии, помогая котам построить городок для туристов
        </LearnDescription>
